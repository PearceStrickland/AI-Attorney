...
function GameScreen() {
    const entriesList = [
        ...
        { interactionType: 'linear', scene: 'witness', dialogues: [[witness_aiexpert, "T hank you. I’ve reviewed the AI system used by the University of Georgia. While AI can efficiently process data, it often lacks the ability to fully understand the nuances of human experiences and backgrounds."]], author: "Dr. Jane Smith"},
        { interactionType: 'linear', scene: 'prosecutor', dialogues: [[prosecutor_neutral, "D r. Smith, isn’t it true that AI reduces human bias in admissions?"]], author: "Opposing Attorney"},
        { interactionType: 'linear', scene: 'witness', dialogues: [[witness_aiexpert, "W hile it can reduce certain biases, it also risks introducing new ones, depending on the data it’s trained on and the criteria set by the institution."]], author: "Dr. Jane Smith"},
        ...
        { interactionType: 'linear', scene: 'witness', dialogues: [[witness_admissionofficer, "I n my experience, the AI system was a tool, but it couldn’t capture the whole picture. Many of us felt that some decisions made by the AI didn’t reflect the values and goals of the college."]], author: "John Doe"},
        { interactionType: 'linear', scene: 'prosecutor', dialogues: [[prosecutor_angry, "M r. Doe, isn’t it the case that the college’s admission standards have always been maintained?"]], author: "Opposing Attorney"},
        { interactionType: 'linear', scene: 'witness', dialogues: [[witness_admissionofficer, "T he standards were maintained, but the process felt impersonal. We used to consider the student's story, their potential. The AI focuses more on metrics."]], author: "John Doe"},

        { interactionType: 'linear', scene: 'attorney', dialogues: [[attorney_talking, "L et’s hear from student Erica who believes they were unfairly evaluated by the AI system."]], author: "You"},
        { interactionType: 'linear', scene: 'witness', dialogues: [[student_sad, "I  was devastated when I got rejected. I had worked so hard, and it felt like the AI just ignored everything that I thought made me a good candidate."]], author: "Erica"},
        { interactionType: 'linear', scene: 'prosecutor', dialogues: [[prosecutor_angry, "B ut isn’t it possible that the competition was simply too strong that year?"]], author: "Opposing Attorney"},
